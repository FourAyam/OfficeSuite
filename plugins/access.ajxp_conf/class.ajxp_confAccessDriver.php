...
class ajxp_confAccessDriver extends AbstractAccessDriver
{
    ...
    public function switchAction($action, $httpVars, $fileVars)
    {
        ...
        switch ($action) {
			...
			//FourAyam
                        $data["USER"]["MANAGER"] = $userObject->getManagerByUserId($usrId,0);
                        //error_log("managers".serialize(array_keys(AuthService::listUsers())),0);
			//$data["USER"]["MANAGER"] = array("root","rooter");
         		
			$data["ALL"]["MANAGERS"] = array_keys(AuthService::listUsers());
	    ...
	    //FourAyam
            case "user_add_manager" :
            case "user_delete_manager":

                if (!isSet($httpVars["user_id"]) || !isSet($httpVars["manager"]) || !AuthService::userExists($httpVars["user_id"]) || !AuthService::userExists($httpVars["manager"])) {
                    throw new Exception($mess["ajxp_conf.61"]);
                }
                if ($action == "user_add_manager") {
                    $act = "add";
                    $messId = "126";
                } else {
                    $act = "remove";
                ...
                $this->updateUserManager($httpVars["user_id"], $httpVars["manager"], $act);
                AJXP_XMLWriter::header();
                AJXP_XMLWriter::sendMessage($mess["ajxp_conf.".$messId].$httpVars["user_id"], null);
                AJXP_XMLWriter::close();
                return ;
            ...
            case "create_repository" :
                ...
                if (strstr($repDef["DRIVER"], "ajxp_template_") !== false) {
					...
					//FourAyam
					if($metaID=="meta.task"){
						$defaultParams["meta_fields"]="status";
						$defaultParams["meta_labels"]="Status";
						$defaultParams["meta_types"]="string";
						$defaultParams["meta_visibility"]="visible";
						
						$defaultParams["meta_fields_1"]="timespent";
						$defaultParams["meta_labels_1"]="TimeSpent";
						$defaultParams["meta_types_1"]="string";
						$defaultParams["meta_visibility_1"]="visible";

						$defaultParams["meta_fields_2"]="timeallocated";
						$defaultParams["meta_labels_2"]="TimeAllocated";
						$defaultParams["meta_types_2"]="string";
						$defaultParams["meta_visibility_2"]="visible";

						$defaultParams["meta_fields_3"]="createdby";
						$defaultParams["meta_labels_3"]="CreatedBy";
						$defaultParams["meta_types_3"]="string";
						$defaultParams["meta_visibility_3"]="visible";

						$defaultParams["meta_fields_4"]="createdon";
						$defaultParams["meta_labels_4"]="CreatedOn";
						$defaultParams["meta_types_4"]="string";
						$defaultParams["meta_visibility_4"]="visible";

						$defaultParams["meta_fields_5"]="assignedby";
						$defaultParams["meta_labels_5"]="AssignedBy";
						$defaultParams["meta_types_5"]="string";
						$defaultParams["meta_visibility_5"]="visible";

						$defaultParams["meta_fields_6"]="assignedto";
						$defaultParams["meta_labels_6"]="AssignedTo";
						$defaultParams["meta_types_6"]="string";
						$defaultParams["meta_visibility_6"]="visible";

						$defaultParams["meta_fields_7"]="assignedby";
						$defaultParams["meta_labels_7"]="AssignedBy";
						$defaultParams["meta_types_7"]="string";
						$defaultParams["meta_visibility_7"]="visible";

						$defaultParams["meta_fields_8"]="assignedon";
						$defaultParams["meta_labels_8"]="AssignedOn";
						$defaultParams["meta_types_8"]="string";
						$defaultParams["meta_visibility_8"]="visible";

						$defaultParams["meta_fields_9"]="acceptedby";
						$defaultParams["meta_labels_9"]="AcceptedBy";
						$defaultParams["meta_types_9"]="string";
						$defaultParams["meta_visibility_9"]="visible";

						$defaultParams["meta_fields_10"]="acceptedon";
						$defaultParams["meta_labels_10"]="AcceptedOn";
						$defaultParams["meta_types_10"]="string";
						$defaultParams["meta_visibility_10"]="visible";

						$defaultParams["meta_fields_11"]="startedby";
						$defaultParams["meta_labels_11"]="StartedBy";
						$defaultParams["meta_types_11"]="string";
						$defaultParams["meta_visibility_11"]="visible";

						$defaultParams["meta_fields_12"]="startedon";
						$defaultParams["meta_labels_12"]="StartedOn";
						$defaultParams["meta_types_12"]="string";
						$defaultParams["meta_visibility_12"]="visible";

						$defaultParams["meta_fields_13"]="pausedby";
						$defaultParams["meta_labels_13"]="PausedBy";
						$defaultParams["meta_types_13"]="string";
						$defaultParams["meta_visibility_13"]="visible";

						$defaultParams["meta_fields_14"]="pausedon";
						$defaultParams["meta_labels_14"]="PausedOn";
						$defaultParams["meta_types_14"]="string";
						$defaultParams["meta_visibility_14"]="visible";

						$defaultParams["meta_fields_15"]="finishedby";
						$defaultParams["meta_labels_15"]="FinishedBy";
						$defaultParams["meta_types_15"]="string";
						$defaultParams["meta_visibility_15"]="visible";

						$defaultParams["meta_fields_16"]="finishedon";
						$defaultParams["meta_labels_16"]="FinishedOn";
						$defaultParams["meta_types_16"]="string";
						$defaultParams["meta_visibility_16"]="visible";

						$defaultParams["meta_fields_17"]="hiddenfrom";
						$defaultParams["meta_labels_17"]="HiddenFrom";
						$defaultParams["meta_types_17"]="string";
						$defaultParams["meta_visibility_17"]="hidden";
						}
					else
					{
    ...
    //FourAyam
    public function updateUserManager($userId, $manager, $addOrRemove, $updateSubUsers = false)
    {
        $confStorage = ConfService::getConfStorageImpl();
        $user = $confStorage->createUserObject($userId);
        //if($user->hasParent()) return $user;
        if ($addOrRemove == "add") {
            $user->addManager($userId,$manager);
        } else {
            $user->removeManager($userId,$manager);
        }

 ...
 * @subpackage Meta
 */
class TaskMetaManager extends AJXP_Plugin
{
    /**
    ...
    public function initMeta($accessDriver)
    {
        ...
        if ($store === false) {
            throw new Exception("The 'meta.task' plugin requires at least one active 'metastore' plugin");
        }
	...
	$loggedUser = AuthService::getLoggedUser();
        ...
        $cdataHead = '<div>
                        <div class="panelHeader infoPanelGroup" colspan="2"><span class="icon-edit" data-ajxpAction="edit_user_meta" title="AJXP_MESSAGE[meta.task.1]"></span>AJXP_MESSAGE[meta.task.1]</div>

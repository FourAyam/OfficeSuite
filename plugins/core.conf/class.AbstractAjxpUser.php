...
abstract class AbstractAjxpUser implements AjxpGroupPathProvider
{
    ...
    {
		return ConfService::getConfStorageImpl()->getReportersByManagerid($userid,$opt);
    }
    public function getManagerByUserId($userid,$opt)
    {
		return ConfService::getConfStorageImpl()->getManagerByUserid($userid,$opt);
    }
    public function addManager($userid,$manager)
    {
	return ConfService::getConfStorageImpl()->addManagerByUserid($userid,$manager);
    }
    public function removeManager($userid,$manager)
    {
	return ConfService::getConfStorageImpl()->removeManagerByUserid($userid,$manager);
    }
